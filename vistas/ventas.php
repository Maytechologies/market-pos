            ...
            <div class="col-md-3">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body p-2">
                        ...
                        <!-- MOSTRAR EL SUBTOTAL, impuesto Y TOTAL DE LA VENTA -->
                        <div class="row">
                            <div class="col-md-7">
                                <span>SUBTOTAL</span>
                            </div>
                            ...
                            <div class="col-md-5 text-right">
                                $ <span class="" id="boleta_impuesto">0.00</span>
                            </div>
...
$(document).ready(function(){
    ...
    /*======================================================================================
    TRAER EL NRO DE BOLETA DESDE LA TABLA EMPRESA 
    ======================================================================================*/
    CargarNroBoleta();


    /*======================================================================================
    === EVENTO VACIAR ITEMS DE PRODUCTOS DE LA TABLA VENTAS
    ======================================================================================*/
   ...
   /* =======================================================================================
    ...
    function CargarNroBoleta() { 
            ...
            //Realizamos una peticion JSON por metodo POST
            //con una accion 1 lo que nos devuelva respueta 
            //lo asignamos a dos variables serie_boleta nro_boleta
            ...
            $.ajax({
                ...
                success: function(respuesta) {
                    ...
                    //los valores almacenado en estas variables
                    //lo mostramos en los id iptNroSerie / iptNroVenta 
    ...
    /*====================================================================*/
    //FUNCION PARA LIMPIAR LOS INPUTS DE LA BOLETA Y ETIQUETAS CON DATOS
    /*====================================================================*/
    ...
    function realizarVenta(){
        ...
        if (count > 0) {
            ...
            if ($("#iptEfectivoRecibido").val() > 0 && $("#iptEfectivoRecibido").val() != "") {
                ...
                //Llamamos la instancia FormData y declaramos la Variable arr con un Arreglo vacio 
                var formData = new FormData();
			    var arr = [];


                //iniciamos un foreach donde por cada fila generamos un datos 
                table.rows().eq(0).each(function(index) {
		            
                    //En la variable row almacenamos los datos capturados en el foreach 
                    var row = table.row(index);
                    //En data recibimos todos los campos de todos los items de nuestra table 
                    var data = row.data();
                    
                    //Indicamos lo campos especificos de la variable data y los concatenamos en un array denominado arr[]
                    //Estos datos son los que necesitamos para la tabla VENTA_DETALLES
                    arr[index] = data['codigo_producto'] + "," + parseFloat(data['cantidad']) + "," + data['total'].replace("$", "");
                    
                    //por cada elemento recibido del array le asignamos un index
                    formData.append('arr[]', arr[index]);

                });

                 //Estos campos son los necesarios para alimentar la tabla VENTA_CABECERA
                ...
                $.ajax({
                    ...
                    success: function(respuesta) {
                        ...
                        table.clear().draw(); //LIMPIAMOS LOS DATOS DE NUESTRA DATATABLE VENTAS
                        
                        LimpiarInputs();//LIMPIAMOS TODOS LOS IMPUT Y LABES DE NUESTRO MODULO DE VENTAS

                        CargarNroBoleta();//CARGAMOS EL NUMERO DE BOLETA Y NUEMRO DE SERIE
