     ...
     <div class="container-fluid">
         ...
         <div class="row">
             ...
             <div class="col-lg-6">
                 <div class="card card-info">
                     <div class="card-header">
                         <h3 class="card-title">Productos Con Stock Minimo</h3>
                         <div class="card-tools">
                             <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                 <i class="fas fa-minus"></i>
                             </button>
                             ...
                             <table class="table" id="tbl_productos_poco_stock">
                                 <thead>
                                     <tr class="text-black">
                                         ...
                                         <th>Producto</th>
                                         <th style="margin: auto;">Cantidad-Actual</th>
                                         <th style="justify-content: center;">Stock-Minimo</th>
                                     </tr>
                                 </thead>
                                 <tbody></tbody>
                             </table>
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            $("#totalGanancias").html(' $ ' + respuesta[0]['ganancias'].replace(
                /\d(?=(\d{3})+\.)/g, "$&,"))
            $("#stockMinimo").html(respuesta[0]['stockMinimo'])
    ...
    /* =======================================================
         SOLICITUD AJAX TABLA DE PRODUCTOS MAS VENDIDOS
    =======================================================*/
   ...
   /* =======================================================
       SOLICITUD AJAX TABLA DE PRODUCTOS CON STOCK MINIMO
    =======================================================*/
        ...
        success:function(respuesta){
            ...
            for (let i = 0; i < respuesta.length; i++) {
                filas = '<tr>'+
                            ...
                            '<td class="text-center text-danger">' + respuesta[i]["minimo_stock_producto"] + '</td>'+
                        '</tr>'
