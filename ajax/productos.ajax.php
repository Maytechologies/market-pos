...
class ajaxProductos{
    ...
    /* Declaramos Variables con acceso publico para asignarle valores 
    que viajan por metodo POST desde el formulario */
    ...
    //Funcion para solicitar al controlador el listado de los productos
    ...
    /*===================================================================
    MOSTRAR LISTADO DE PRODUCTOS PARA INPUT DE AUTO COMPLETADO VENTAS
    ====================================================================*/
...
if(isset($_POST['accion']) && $_POST['accion'] == 1){ // parametro para listar productos
    ...
    $productos = new ajaxProductos();//llamamos la clase ajaxProductos
    $productos -> ajaxListarProductos();// Ejecutamos la función ListarProductos
